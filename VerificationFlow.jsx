                ...
                <React.Fragment key={s.key}>
                  <div className="flex flex-col items-center gap-1 shrink-0">
                    ...
                    <div className="flex flex-col items-center gap-0.5">
                      ...
                      {!s.required && (
                        <span className="text-[7px] text-hz-gold font-black leading-none">optional</span>
                      )}
                    </div>
                  </div>
                  {i < PROGRESS_STEPS.length - 1 && (
                    <div className={`flex-1 h-[2px] mb-4 mx-1 rounded-full transition-all duration-500 ${
                      done ? 'bg-hz-green' : 'bg-gray-200'
                    }`} />
                  )}
                </React.Fragment>
              );
